...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['White Flash', "Value 1: How long you want it to fade out."]
	];
	...
	**/
	...
	override function create()
	{
		...
		var eventIcon:FlxSprite = new FlxSprite(-GRID_SIZE - 5, -90).loadGraphic(Paths.image('menus/editors/eventArrow'));
		...
		quant = new AttachedSprite('chart_quant','menus/editors/chart_quant');
	...
	function setupNoteData(i:Array<Dynamic>, isNextSection:Bool):Note
	{
		...
		if(daSus != null) { //Common note
			...
			note.loadGraphic(Paths.image('menus/editors/eventArrow'));
